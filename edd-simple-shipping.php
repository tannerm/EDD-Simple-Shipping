...
class EDD_Simple_Shipping {
	...
	public function __construct() {
		...
		define( 'EDD_SIMPLE_SHIPPING_VERSION', '1.5.1' );
...
add_action( 'fes_custom_post_button', 'edd_fes_simple_shipping_field_button' );
...
add_action( 'fes_admin_field_edd_simple_shipping', 'edd_fes_simple_shipping_admin_field', 10, 3 );
...
add_filter( 'fes_formbuilder_custom_field', 'edd_fes_simple_shipping_formbuilder_is_custom_field', 10, 2 );
...
add_action( 'fes_submission_form_save_custom_fields', 'edd_fes_simple_shipping_save_custom_fields' );
...
add_action( 'fes_render_field_edd_simple_shipping', 'edd_fes_simple_shipping_field', 10, 3 );